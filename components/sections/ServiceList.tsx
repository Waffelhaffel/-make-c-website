...
import { servicePagePath } from "@/lib/leistungen";
...
type ServiceListProps = {
  services: Service[];
  /**
   * Auf der Startseite steht die Liste unter der Hero-H1 → h3.
   * Auf /leistungen steht sie direkt unter der Seiten-H1 → h2.
   */
  headingLevel?: "h2" | "h3";
};
...
export function ServiceList({ services, headingLevel = "h3" }: ServiceListProps) {
  return (
    <MotionSection
      id="service"
